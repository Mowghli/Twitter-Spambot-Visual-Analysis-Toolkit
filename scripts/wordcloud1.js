function wordcloudset1() {
	var users = ["legitimate_users", "content_users"]
	var tweetcount = [50, 100, 400]
	var files = ["./data/processed/Dataset_1/set1legitimate_50.json", "./data/processed/Dataset_1/set1legitimate_100.json", "./data/processed/Dataset_1/set1legitimate_400.json", "./data/processed/Dataset_1/set1polluted_50.json", "./data/processed/Dataset_1/set1polluted_100.json", "./data/processed/Dataset_1/set1polluted_400.json"]
	...
	d3.json("./data/processed/Dataset_1/set1legitimate_50.json", function(error, data) {
		//console.log(data)
		...
		function update(dataset) {
			...
			d3.select(".wordcloudset1").selectAll("g").remove();
			d3.select(".wordcloudset1").remove();
			//d3.select("svg").remove();
			//svg1.remove()
